...
INSERT INTO `m_pulsa` (`pulsa_id`, `provider_id`, `pulsa_status`, `nominal_pulsa_id`, `pulsa_buy_at`) VALUES
	(1, 1, 1, 3, '2024-07-16 05:17:04'),
	(2, 1, 0, 1, '2024-07-02 09:35:16'),
	(3, 1, 1, 2, '2024-07-16 07:35:15'),
	(4, 1, 0, 2, NULL),
	(6, 1, 0, 3, NULL),
	(7, 1, 0, 1, NULL),
...
INSERT INTO `m_token_pln` (`token_pln_id`, `list_no_pln_id`, `nominal_pln_id`, `token_pln_kode`, `token_pln_status`, `token_buy_at`) VALUES
	...
	(3, NULL, 3, 43123456, 1, '2024-07-16 05:30:44'),
	(4, NULL, 4, 12345645, 1, '2024-07-16 07:36:36');
...
INSERT INTO `m_voucher` (`voucher_id`, `nominal_voucher_id`, `user_id`, `is_redeemed`, `redeemed_at`) VALUES
	(1, 3, 1, 0, '2024-07-16 05:17:04'),
	(2, 2, 1, 1, '2024-07-16 07:36:36'),
	(3, 1, 1, 0, '2024-07-16 07:35:15');
...
-- Dumping data for table ecoshop.sessions: ~2 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('iys9kgW56tnNODxDNxb6ZmHcdSr2jjM150h9o5EM', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', '', 1721140610),
	('PWBKl1JZNlLodenC7tNYAn6VdSlZSFXmHNFmEc7k', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', '', 1721133230);
...
INSERT INTO `t_invoice` (`invoice_id`, `voucher_id`, `invoice_no`, `invoice_type`, `nomor_telp`, `no_pln_ui`, `invoice_total`, `invoice_status`, `updated_at`, `created_at`) VALUES
	...
	(22, 1, 'Ax7s0sUYGt', 2, '08642687878', 0, 5000, 1, '2024-07-16 12:17:04', '2024-07-16 12:17:04'),
	(23, 2, 'QPCear35M1', 1, NULL, 111222, 43000, 1, '2024-07-16 12:30:44', '2024-07-16 12:30:44'),
	(24, 3, 'x5hx5SkclW', 2, '07654543', 0, 5000, 1, '2024-07-16 14:35:15', '2024-07-16 14:35:15'),
	(25, 2, 'NfJSjnBKaJ', 1, NULL, 111222, 93000, 1, '2024-07-16 14:36:36', '2024-07-16 14:36:36');
...
INSERT INTO `t_invoice_detail` (`invoice_detail_id`, `invoice_id`, `token_pln_id`, `tagihan_pdam_id`, `pulsa_id`, `created_at`) VALUES
	...
	(18, 22, NULL, NULL, 1, '2024-07-16 12:17:04'),
	(19, 23, 3, NULL, NULL, '2024-07-16 12:30:44'),
	(20, 24, NULL, NULL, 3, '2024-07-16 14:35:15'),
	(21, 25, 4, NULL, NULL, '2024-07-16 14:36:36');
...
-- Dumping data for table ecoshop.users: ~3 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(6, 'coba', 'coba1234@gmail.com', NULL, '$2y$12$rRrNyTjDf0K28YV278iynufsxFS9FMXFvTEB11QI8WaFsbV8uGYq.', NULL, '2024-07-16 05:01:42', '2024-07-16 05:01:42');
